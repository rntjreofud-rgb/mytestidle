        ...
        ownedBuildings.forEach(b => {
            ...
            if (!ctrlCard) {
                ...
                ctrlCard.innerHTML = `
                    ...
                    <div class="si-desc" style="bottom:45px; right: 90px;"></div> <!-- 왼쪽 하단: 생산 정보 -->
                    <div class="si-cost" style="top:auto; bottom:45px; right:14px; font-size:0.8rem;"></div> <!-- 오른쪽 하단: 에너지 -->
