export const earthData = {
    initialResources: ['wood', 'stone', 'plank'],
    houseStages : [
    // 0~9: 기초
    ...
    { name: "이온 엔진 테스트", desc: "푸른 빛의 엔진을 점화해봅니다.", req: { energy: 3000, battery: 5000, quantumData: 2000 } },
    { name: "외부 방어막", desc: "미세 소행성으로부터 선체를 보호합니다.", req: { gravityModule: 100, advCircuit: 10000, titaniumPlate: 10000 } },
    { name: "도킹 베이 증설", desc: "다른 우주선과 만날 준비를 합니다.", req: { gravityModule: 5000, steel: 50000, concrete: 20000 }  },
    // 40~50: 최종 발사 단계
    ...
    { name: "비행 소프트웨어 동기화", desc: "마지막 코드를 업로드합니다.", req: { processor: 10000, quantumData: 10000 } },
    ...
    { name: "선내 시스템 가동", desc: "모든 장치가 '정상' 신호를 보냅니다.", req: { gravityModule: 2000, advAlloy: 2000, advCircuit: 50000, processor: 20000 } },
    ...
    { id: 37, name: "중력 제어 연구소", cost: { nanobots: 1000, advAlloy: 2000, titaniumPlate: 10000 }, inputs: { energy: 5000, quantumData: 5 }, outputs: { gravityModule: 1 }, count: 0, reqLevel: 36 },
    ...
    { id: "warp_field_stab", name: "워프 필드 안정화", desc: "추진기 공장 및 중력 연구소 재료 소모량 25% 감소", cost: { warpCore: 5, gravityModule: 500, aiCore: 1000 }, type: 'consumption', value: 0.75, target: [37, 38], reqResearch: "final_prep" },
