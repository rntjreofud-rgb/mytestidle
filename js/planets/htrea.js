export const htreaData = {
    ...
    { name: "낡은 전선 복구", desc: "수천 미터의 구리선을 다시 이어야 합니다.", req: { scrapCopper: 10000 } },
    { name: "방사능 차폐막", desc: "외부의 오염된 공기를 완벽히 차단합니다.", req: { leadPlate: 20000, radiation: 5000 , energy: 500} },
    ...
    { name: "선실 가압 시스템", desc: "내부 공기 누출을 확인합니다.", req: { brokenParts: 500000000, microChip: 50000000, nanobots: 100000 } },
    { name: "과거의 기억 전송", desc: "은하 전역으로 신호를 송출합니다.", req: { dataCore: 20000000, scrapCopper: 100000000, aiCore: 5000 } },
    ...
    buildings: [
        ...
        // [FIX] Lv.9 승급(바이오샘플) 대비 -> Lv.6 해금
        { id: 306, name: "바이오 실험실", cost: { pureWater: 2000, leadPlate: 500 }, inputs: { pureWater: 10, energy: 100 }, outputs: { bioSample: 2.0 }, count: 0, reqLevel: 6 },
        
        // [FIX] Lv.15 승급(데이터코어) 및 용광로 재료 대비 -> Lv.8 해금
        { id: 307, name: "메모리 뱅크 복구기", cost: { scrapCopper: 5000, bioSample: 100 }, inputs: { energy: 300 }, outputs: { dataCore: 1.0 }, count: 0, reqLevel: 8 },
        
        // [FIX] Lv.10 승급(나무) 대비 -> Lv.8 해금
        { id: 310, name: "오염 토양 정화구역", cost: { pureWater: 1000, bioSample: 100 }, inputs: { pureWater: 10, energy: 50 }, outputs: { wood: 5.0 }, count: 0, reqLevel: 8 },
        
        // [FIX] Lv.11 승급(돌) 대비 -> Lv.9 해금
        { id: 311, name: "폐건물 골재 파쇄기", cost: { brokenParts: 5000, scrapCopper: 1000 }, inputs: { energy: 100 }, outputs: { stone: 10.0 }, count: 0, reqLevel: 9 },
        
        // [FIX] Lv.12 승급(철판) 대비 -> Lv.10 해금
        ...
        // [FIX] Lv.24 승급(오일) 대비 -> Lv.23 해금
        { id: 319, name: "심해 유전 인양정", cost: { steel: 20000, microChip: 500 }, inputs: { energy: 5000 }, outputs: { oil: 2000.0 }, count: 0, reqLevel: 22 },
        
        // [FIX] Lv.25 승급(플라스틱) 대비 -> Lv.24 해금
        { id: 320, name: "고대 화학 복합단지", cost: { steel: 50000, pureWater: 100000 }, inputs: { oil: 500, energy: 8000 }, outputs: { plastic: 500.0, sulfur: 300.0, rocketFuel: 100.0 }, count: 0, reqLevel: 23 },
        ...
        // [FIX] Lv.28 승급(공허수정) 대비 -> Lv.27 해금 (균열)
        { id: 346, name: "불안정한 공허 균열", cost: { plastic: 50000, circuit: 10000 }, inputs: { energy: 100000, radiation: 10000 }, outputs: { voidCrystal: 0.5 }, count: 0, reqLevel: 26 },
        { id: 339, name: "지열 발전 플랜트", cost: { steel: 30000, glass: 10000 }, inputs: { pureWater: 10000 }, outputs: { energy: 50000 }, count: 0, reqLevel: 27 },
        
        // [FIX] Lv.28 승급(유리) 대비 -> Lv.28 해금 (바로 건설)
        { id: 323, name: "대형 납 유리 용해로", cost: { leadPlate: 1000000, stone: 500000 }, inputs: { stone: 10000, energy: 15000 }, outputs: { glass: 1000.0 }, count: 0, reqLevel: 27 },
