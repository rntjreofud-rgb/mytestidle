...
export const researchList = [
    ...
    // Tier 3: 전기 시대
    { id: "power_grid", name: "전력망 최적화", desc: "풍력/화력 발전 출력 2.5배", cost: { copperPlate: 500, circuit: 50 }, type: 'building', target: [8, 13], value: 2.5, reqResearch: "smelting_up" },
    ...
    // Tier 4: 화학 및 첨단
    { id: "oil_cracking", name: "원유 분해공학", desc: "시추기 및 정제소 속도 2배", cost: { plastic: 500, steel: 1000 }, type: 'building', target: [18, 17], value: 2, reqResearch: "drill_hard" },
    { id: "high_precision", name: "나노 정밀도", desc: "조립 및 고급 조립 속도 4배", cost: { advCircuit: 500, optics: 200 }, type: 'building', target: [10, 21], value: 4, reqResearch: "oil_cracking" },
    { id: "super_battery", name: "고밀도 리튬 배터리", desc: "발전 시설 전체 출력 2배", cost: { battery: 1000, processor: 100 }, type: 'building', target: [8, 13, 20], value: 2, reqResearch: "high_precision" },
    ...
    { id: "nanotech_god", name: "나노 코팅 도구", desc: "수동 채집량 +200", cost: { nanobots: 1000, advAlloy: 1000 }, type: 'manual', value: 200, reqResearch: "warp_theory" }
];

// [5] 50단계 하우스(우주선) 발전 단계
export const houseStages = [
    // 0~10: 정착
    { name: "임시 야영지", desc: "비를 피할 곳이 필요합니다.", req: { wood: 10 } },
    { name: "나뭇잎 움막", desc: "조금 더 따뜻해졌습니다.", req: { wood: 50 } },
    { name: "목재 오두막", desc: "제법 집 같은 모양새입니다.", req: { wood: 100, plank: 20 } },
    { name: "돌담집", desc: "돌로 벽을 보강했습니다.", req: { wood: 300, stone: 100 } },
    { name: "벽돌집", desc: "철판을 얻기 위해 문을 보강하세요.", req: { stone: 500, brick: 50 } },
    { name: "강철 보강문", desc: "콘크리트로 지하 대피소를 만드세요.", req: { ironPlate: 20, plank: 100 } }, // Lv.5 (이때 콘크리트 해금)
    { name: "지하 대피소", desc: "폭격에도 안전한 벙커입니다.", req: { stone: 1000, concrete: 30 } },
    ...
    { name: "방사능 차폐벽", desc: "납과 콘크리트로 외벽을 감쌉니다.", req: { concrete: 2000, lead: 500 } },
    ...
    // 40~50: 발사 준비
    { name: "메인 엔진 장착", desc: "집 하단에 거대 엔진을 다옵니다.", req: { steel: 200000, rocketFuel: 5000 } },
